...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 24 oct. 2018 à 09:23
...
CREATE TABLE `t_skills` (
  ...
  `category` enum('front','back','cms','framework','langue') NOT NULL,
  `id_user` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Déchargement des données de la table `t_social_networks`
--

INSERT INTO `t_social_networks` (`id_social_network`, `network`, `url`, `id_user`) VALUES
(1, 'GitHub', 'www.github.com', 1);
...
--
-- Déchargement des données de la table `t_trainings`
--

INSERT INTO `t_trainings` (`id_training`, `dates_training`, `title_training`, `subtitle_training`, `training_establishment`, `id_user`) VALUES
(3, '2015', 'nono', 'nene', 'nunu', 1);
...
INSERT INTO `t_users` (`id_user`, `firstname`, `lastname`, `email`, `phone`, `password`, `username`, `age`, `birthday`, `gender`, `civilstatus`, `address`, `zip`, `city`, `country`, `comments`, `statut`) VALUES
...
--
ALTER TABLE `t_hobbies`
  MODIFY `id_hobby` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `t_social_networks`
  MODIFY `id_social_network` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_trainings`
  MODIFY `id_training` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
